...
@mock_ec2
def test_revert_baseline_lambda_no_instances_to_patch(mock_aws_environment):
    # setup: none
    # invoke lambda
...
@mock_ec2
def test_revert_baseline_lambda_happy_path(mock_aws_environment):
    # setup
    from critical_patching import revert_baseline_function # accept the moto mocked client, need __init__.py files for module reference
...
@mock_ec2
def test_revert_baseline_lambda_no_matching_ec2s(mock_aws_environment):
    # setup
    from critical_patching import revert_baseline_function # accept the moto mocked client, need __init__.py files for module reference
